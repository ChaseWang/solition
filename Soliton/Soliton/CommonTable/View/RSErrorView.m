...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _titleButton.backgroundColor = UIColorFromRGB(0xf1f3f4); //RGBACOLOR(0xe3, 0xe4, 0xe5,0.6);
        _titleButton.userInteractionEnabled = NO; // 默认无操作
        [_titleButton setTitleColor:RGBCOLOR(0x50, 0x50, 0x50)
                           forState:UIControlStateNormal];
        [_titleButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
        ...
        _subtitleView.backgroundColor = [UIColor clearColor]; //RGBACOLOR(0xe3, 0xe4, 0xe5,0.6);
        _subtitleView.textColor = RGBCOLOR(0x50, 0x50, 0x50);
