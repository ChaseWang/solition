...
+ (UIImage *)image:(UIImage *)image overlayImage:(UIImage *)overlayImage{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(image.size.width, image.size.height),
                                           NO,
                                           image.scale);
    [image drawInRect:CGRectMake(0, 0, image.size.width, image.size.height)];
    [overlayImage drawInRect:CGRectMake(0.5 *(image.size.width - overlayImage.size.width),
                                        0.5 *(image.size.height - overlayImage.size.height),
